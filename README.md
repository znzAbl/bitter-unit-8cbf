...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-unit-8cbf
```

A live public deployment of this template is available at [https://bitter-unit-8cbf.templates.workers.dev](https://bitter-unit-8cbf.templates.workers.dev)
